...
const Following = ({ followingUser }) => {
  return (
    <>
      <div
        className=" flex-row items-center pointer p-10 postHover followers"
        data-username={followingUser.username}
      >
        <img
        ...
        <div className=" flex-1 ml-10">
          <Link to={`/profile/${followingUser.username}`}>
            ...
            <span className="block font-450 text-secondary font-xs ">
