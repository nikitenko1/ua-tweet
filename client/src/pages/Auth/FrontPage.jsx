    ...
    <div className="frontPage">
      ...
      <div className="frontPage__right">
        <div className="frontPage__right--content">
          ...
          <span className="font-2xl font-700 mt-40 pb-10 block">
            See what's hapenning in the world right now
          </span>
          <span className="mb-20 mt-40 pt-20 font-700 font-md block">
            Join Twitterf today.
          </span>
          <Link to="signup">
            <button
              type="button"
              className="fill-button block w-100 text-white"
          ...
          <Link to="login">
            <button
              type="button"
              className="outline-button mt-15 mb-15 block w-100"
              style={{ padding: '15px 20px' }}
            >
              Log in
            </button>
