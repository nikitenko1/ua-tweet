...
import { ImageIcon, EmojiIcon, GifIcon } from './forms/Icon';
import ToolTip from './forms/ToolTip';
import { RECENT_POST } from '../redux/constants/postConstants';
import Gif from './forms/Gif';
import TextareaAutosize from '@material-ui/core/TextareaAutosize';
import LinearProgress from '@material-ui/core/LinearProgress';
import CircularProgress from '@material-ui/core/CircularProgress';
import useMediaQuery from '@material-ui/core/useMediaQuery';

const EmojiPicker = React.lazy(() => import('./emoji/EmojiPicker'));
...
const TweetContainer = ({
  ...
  useEffect(() => {
    if (!postText && !imageUrl) setDisable(true);
    ...
    <>
      <div className="flex-row ml-spacing mt-10 mb-10">
        ...
        <div className="flex-column flex-1">
          <TextareaAutosize
            rowsMax={6}
            rowsMin={textareaMinHeight}
            maxLength="300"
            autoFocus={true}
            spellCheck="false"
            className="tweetTextarea p-10"
          ...
          <div className="flex-row items-center justify-between">
            <div>
              <ToolTip title="image">
                <div
                  className={`bgHover inline-block p-7 border-round ${
                    smallScreen && 'pr-0'
                  }`}
                >
                  <label htmlFor={label}>
      ...
      {/* Show a spinner while the EmojiPicker is loading */}
