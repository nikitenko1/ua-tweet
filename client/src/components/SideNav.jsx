    ...
    <div className="sidenavContainer">
      ...
      <div ref={sidenav} className="sidenav">
        <div className="flex-row p-10">
          ...
          <span className="pointer" onClick={handleClickClose}>
            <CloseIcon />
          </span>
        </div>
        <hr />
        <div className="ml-10 mt-10">
          ...
          <div className="ml-10 mt-20 mb-20 text-secondary">
            <span>
              <span className="font-600 text-dark">
        ...
        <Link to={`/profile/${userInfo.username}`} onClick={handleClickClose}>
          <div className="flex items-center bgLightHover pt-10 pb-10 pl-10 mt-10">
            <ProfileIcon className="fill-rootText svg-15" />
            <span className="ml-10">Profile</span>
          </div>
        </Link>
        <Link to={`/bookmark`} onClick={handleClickClose}>
          <div className="flex items-center bgLightHover pt-10 pb-10 pl-10 mt-10">
            <BookmarkIcon className="fill-rootText svg-15" />{' '}
            <span className="ml-10">Bookmark</span>
          </div>
        </Link>
        <Link to={`/connect`} onClick={handleClickClose}>
          <div className="flex items-center bgLightHover pt-10 pb-10 pl-10 mt-10">
            <AtIcon className="fill-rootText svg-15" />{' '}
            <span className="ml-10">Connect</span>
          </div>
        </Link>
        <div
          className="flex items-center bgLightHover pt-10 pb-10 pl-10 mt-10"
          onClick={() => {
            handleClickClose();
            setDisplay(true);
          }}
        >
          <DisplayIcon className="fill-rootText svg-15" />{' '}
