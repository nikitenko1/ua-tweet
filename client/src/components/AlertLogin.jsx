...
import { getTime, getDate } from '../components/utils/timeAndDate';
import { TwitterIcon } from '../components/forms/Icon';

const AlertLogin = ({ handleClose, loginInfo, loginTime }) => {
  return (
    <div>
      <BigModal onClose={handleClose}>
        <div className="w-90 m-auto">
          ...
          <div className="text-secondary  font-600 p-20">
            ...
            <p className="mt-15">New login</p>
            <p>Device: {loginInfo.browser}</p>
            <p>Location*: {loginInfo.location}</p>
            <p>
              When: {getDate(new Date(loginTime))} at{' '}
              {getTime(new Date(loginTime))}
            </p>
            <p className="mt-20">
            ...
            <ul className="mt-20">
              ...
              <li>
                ...
                now to protect your account.
              </li>
            </ul>
            <p>
              You'll be logged out of all your active Twitter sessions except
              the one you're using at the time.
            </p>
            <button
              className="fill-button w-90 text-white mt-20"
              onClick={handleClose}
            >
              Got it
            </button>
